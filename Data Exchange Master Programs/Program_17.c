 ...
 * @file Program_17.c
 * @author Vinayak Mali
 * @brief Date exchange master program 17
 * @version 0.1
 * @date 2023-08-18
 * 
...
void allocate_array_of_pointer_to_integer(int*** ppp_arr, int* pN);
...
int main(void)
{
    ...
    allocate_array_of_pointer_to_integer(&pp_arr, &N);
    initialize_array(pp_arr, N);
    show_array(pp_arr, N);

    /*
        release_array(pp+_arr, N);
        pp_arr = 0;
    */
